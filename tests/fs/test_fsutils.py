...
from reny.fstools.rename import Renamer as Reny
from reny.fstools.builders.fsentry import FSEntry, FSEntryDefaults
from reny.fstools.builders.fsprms import FSEntryParamsBase, FSEntryParamsExt, FSEntryParamsFlatten
...
class FSTests(FSTest):
    ...
    @unittest.skipIf(os.name == 'nt', 'skipping for windows')
    def test_reny_replace(self):
        ## python -m unittest tests.fs.test_fsutils.FSTests.test_reny_replace
        fs_entry_params = self._fs_entry(end_level = 4, include = '*test*')
        fcnt_orig, _, _ = DHandler.dir_stats(fs_entry_params)

        Reny.replace(fs_entry_params, find_str = 'test', replace_str = 'flower')
    ...
    def test_reny_add_index_sequential(self):
        ...
        join_str = ' '
        Reny.add_index(fs_entry_params, sequential = True, join_str = join_str, as_prefix = True, min_digits = 2)
    ...
    def test_reny_add_index_multilevel(self):
        ...
        join_str = ' '
        Reny.add_index(fs_entry_params, as_prefix = True, join_str = join_str, min_digits = 2)
    ...
    def test_add_text(self):
        ...
        join_str = ' '
        Reny.add_text(fs_entry_params, text = 'The', as_prefix = True, join_str = join_str)
    ...
    def test_add_date(self):
        ...
        join_str = '_'
        Reny.add_date(fs_entry_params, as_prefix = False, join_str = join_str, format = '%Y-%m-%d')
    ...
    def test_delete_folders(self):
        ...
        # reny -el 5 -in 'nested_c;nested_a*' -fd delete -id -dc
    ...
    def test_delete_non_media(self):
        ...
        # reny -ft media -el 5 -in '*week*' delete
